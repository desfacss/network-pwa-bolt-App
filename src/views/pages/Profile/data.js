...
export function GetOrdersData(rowscount) {
    // prepare the data
    const data = [];
...
export function GeneratePivotData(numberOfRecords, numberOfYears = 4) {
...
export function GetGanttChartTreeData(count = 50, minDate, maxDate) {
    const data = [];
...
export function GetGanttChartFlatData(count = 50, minDate, maxDate) {
    const data = [];
