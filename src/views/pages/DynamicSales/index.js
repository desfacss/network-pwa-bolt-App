...
const Index = () => {
    ...
    if (viewConfig?.calendarview) {
        tabItems.push({
            ...
            // children: <ScheduleView data={data} viewConfig={viewConfig} workflowConfig={workflowConfig} updateData={updateData} deleteData={deleteData} onFinish={handleAddOrEdit} openDrawer={openDrawer} />,
