    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_, record, rowIndex) => (
                <Input
                    value={record.ticket}
                    onChange={(e) => handleInputChange(rowIndex, 'ticket', e.target.value)}
                />
            ),
        },
        {
            ...
            render: (_, record, rowIndex) => (
                <Input
                    ...
                    onChange={(e) => handleInputChange(rowIndex, 'lodging', e.target.value)}
                />
            ),
        },
        {
            ...
            render: (_, record, rowIndex) => (
                <Input
                    value={record.boarding}
                    onChange={(e) => handleInputChange(rowIndex, 'boarding', e.target.value)}
                />
            ),
        },
        {
            ...
            render: (_, record, rowIndex) => (
                <Input
                    value={record.phone}
                    onChange={(e) => handleInputChange(rowIndex, 'phone', e.target.value)}
                />
            ),
        },
        {
            ...
            render: (_, record, rowIndex) => (
                <Input
                    value={record.localConveyance}
                    onChange={(e) => handleInputChange(rowIndex, 'localConveyance', e.target.value)}
                />
            ),
        },
        {
            ...
            render: (_, record, rowIndex) => (
                <Input
                    value={record.incidentals}
                    onChange={(e) => handleInputChange(rowIndex, 'incidentals', e.target.value)}
                />
            ),
        },
        {
            ...
            render: (_, record, rowIndex) => (
                <Input
                    value={record.others}
                    onChange={(e) => handleInputChange(rowIndex, 'others', e.target.value)}
                />
            ),
        },
        {
