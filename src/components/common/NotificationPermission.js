...
const NotificationPermission = ({
  ...
  cardTitle = "Push Notifications", // Customizable card title
  cardDescription = "Enable push notifications to stay updated with important alerts and updates.", // Customizable card description
}) => {
  ...
  const VAPID_PUBLIC_KEY =
    ...
    "BMr-4WJsZHer9LyiG8KiUy-kSH4RRIAWVLizSihOwN1raQrkLLuWIkilc1RY46B2RaMmxnwzEfDZLL60YYvePFU";
  ...
  const openNotificationSettings = () => {
    ...
    if (isIOS) {
      description =
        "To enable notifications, go to Settings > Notifications, find your browser, and allow notifications for this app.";
    } else if (isAndroid) {
      description =
        "To enable notifications, go to Settings > Apps > [Your Browser] > Notifications, and allow notifications for this app.";
    } else if (isChrome) {
      description =
        "To enable notifications, click the menu (three dots) in Chrome, go to Settings > Privacy and Security > Site Settings > Notifications, and allow notifications for this site.";
    } else if (isFirefox) {
      description =
        "To enable notifications, click the menu (three lines) in Firefox, go to Settings > Privacy & Security > Permissions > Notifications > Settings, and allow notifications for this site.";
    } else if (isSafari) {
      description =
        "To enable notifications, go to Safari > Preferences > Websites > Notifications, and allow notifications for this site.";
    } else {
      description =
        "To enable notifications, go to your browser’s settings, find the Notifications or Site Settings section, and allow notifications for this site.";
    }
      ...
      try {
        if (subscription) {
          ...
          const updatedDevices =
            userData.subscriptions?.devices?.filter((device) => device.device_id !== deviceId) || [];
  ...
  return (
    ...
    >
      ...
      <Space style={{ alignItems: "center" }}>
        ...
        <span
          style={{
            color: isNotificationsEnabled ? "#1890ff" : "#999",
            ...labelStyle,
          }}
        >
