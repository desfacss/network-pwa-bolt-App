...
// // Async thunk to fetch the default organization
// export const fetchDefaultOrganization = createAsyncThunk(
//   "auth/fetchDefaultOrganization",
...
//         }
//         dispatch(setSession(data.session)); // Update session with new token
//       }
...
//         return data;
//       } catch (err) {
//         if (err.code === "401" || err.message.includes("Failed to fetch")) {
//           dispatch(removeSession());
//           localStorage.removeItem(AUTH_TOKEN);
...
//           action.payload === "Session expired and could not be refreshed" ||
//           action.payload === "No valid session"
//         ) {
//           state.session = null;
//           state.token = null;
//           state.redirect = "/app/login";
